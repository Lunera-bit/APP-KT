...
import com.cyryel.data.order.OrderStatus
...
class FirebaseDeliveryRepository @Inject constructor(
    ...
    private fun orderFromDocument(doc: com.google.firebase.firestore.DocumentSnapshot): Order? {
        ...
        return try {
                    ...
                    is Map<*, *> -> {
                        ...
                        com.cyryel.data.order.OrderItem(
                            ...
                            variant = variantRaw?.let {
                                com.cyryel.data.product.ProductVariant(
            ...
            val address = com.cyryel.data.order.DeliveryAddress(
            ...
            Order(
                ...
                customerContact = com.cyryel.data.order.CustomerContact(
